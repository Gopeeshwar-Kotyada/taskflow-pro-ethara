...
async function createTask(){
    ...
    const projectRes = await fetch("https://ethara-taskflow-api-production.up.railway.app/api/projects/all",{
    ...
    const res = await fetch("https://ethara-taskflow-api-production.up.railway.app/api/tasks/create",{
        method:"POST",
        headers:{
